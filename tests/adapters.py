...
def run_embedding(
    ...
    torch.nn.Module.load_state_dict(embed, {'weight': weights})
...
def run_swiglu(
    ...
    torch.nn.Module.load_state_dict(swiglu, {
        "w1.weight": w1_weight,
        "w2.weight": w2_weight,
        "w3.weight": w3_weight,
    })
...
def run_scaled_dot_product_attention(
    ...
    """
    from cs336_basics.module import F
...
def run_multihead_self_attention(
    ...
    torch.nn.Module.load_state_dict(mha, {
...
def run_transformer_block(
    ...
    """
    from cs336_basics.module import TransformerBlock, RotaryPositionalEmbedding
    rope = RotaryPositionalEmbedding(
        theta=theta,
        d_k=d_model // num_heads,
        max_seq_len=max_seq_len,
    ...
    torch.nn.Module.load_state_dict(transformer_block, weights)
...
def run_transformer_lm(
    ...
    torch.nn.Module.load_state_dict(transformer_lm, weights)
...
def run_rmsnorm(
    ...
    torch.nn.Module.load_state_dict(rmsNorm, {'weight': weights})
...
def run_cross_entropy(
    ...
    """
    from cs336_basics.module import F
    return F.cross_entropy_loss(inputs, targets)
...
def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float) -> None:
    ...
    """
    from cs336_basics.utils import clip_grads_with_norm_
    clip_grads_with_norm_(parameters, max_l2_norm)
...
def run_get_lr_cosine_schedule(
    ...
    """
    from cs336_basics.optim import LrScheduler
